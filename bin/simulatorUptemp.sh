...
echo `docker run -m 20M --ulimit nofile=90000:90000  -p $ip:161:161/udp -p $ip:3000:3000/udp -itd centos6-jdk7-simulator-traceroute java -Xms5M -Xmx5M  -jar /home/simulator_7_10.jar CXNK$outid  192.167.1.242 744GE 10.7.0.25 $ip`;
sleep 5
done
