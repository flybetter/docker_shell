#!/bin/bash
#echo
echo "ip begin：$1 number:$2  begin eth1:$3";
ip=$1
numb=$2
default=$3
...
echo `docker run -p $ip:161:161/udp -p $ip:3000:3000/udp -itd centos6-jdk7-simulator-traceroute java -Xms10M -Xmx10M  -jar /home/simulator_7_10.jar CXNK$outid  192.167.1.242 744GE 10.7.0.25 $ip`;
done
